                      ...
                      <div aria-labelledby='students-tab-<?php echo $course['course']->id; ?>' class="tab-pane fade" id='students-<?php echo $course['course']->id; ?>' role='tabpanel'>
                          <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if(!empty($course['students'])) {
                                                            foreach($course['students'] as $contract) {
                                                                if($contract['contract']->signature=='') $signed='<br>No Signature';
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href=" <?php echo url('contracts/'.$contract['contract']->contract); ?>" target="_blank" style="color: #da624a;"><i class="fa fa-file-pdf"></i> <?php
                                                                echo $contract['contract']->contract; ?></a>
                                                            <?php echo $signed; ?>
                                                            
                                                            <?php if($contract['contract']->appointments=='0') { ?>
                                                            <br>
                                                            <form action="<?php echo url('admin/generate-appointments') ?>" method="post" onsubmit="return generate_appointments(this, '<?php echo $contract['contract']->id; ?>', '<?php echo $course['course']->id; ?>')">
                                                                <input type="hidden" name="contract_id" value="<?php echo $contract['contract']->id; ?>">
                                                            <?php echo csrf_field(); ?>
                                                            <button class="btn btn-success" id="submit_btn">Generate Appointments</button>
                                                            </form>
                                                            <?php } ?>
                                                        </td>
