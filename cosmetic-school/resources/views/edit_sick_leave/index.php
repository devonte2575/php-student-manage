                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.new_sick_leave'); ?></h5>
                                        <form class="" action="" method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        <label for="exampleEmail11" class=""><?php echo trans('forms.leave_for'); ?> <font style="color:red;">*</font></label>
                                                        <select name="title" class="form-control" required disabled>
                                                            <option value=""><?php echo trans('forms.please_select'); ?></option>
                                                            <option value="Krank" <?php if($sick_leave->title=='Krank') echo 'selected'; ?> >Krank</option>
                                                            <option value="Kind krank" <?php if($sick_leave->title=='Kind krank') echo 'selected'; ?> >Kind krank</option>
                                                            <option value="Todesfall in der Familie" <?php if($sick_leave->title=='Todesfall in der Familie') echo 'selected'; ?> >Todesfall in der Familie</option>
                                                            <option value="Amtstermin" <?php if($sick_leave->title=='Amtstermin') echo 'selected'; ?> >Amtstermin</option>
                                                            <option value="Sonstiges" <?php if($sick_leave->title=='Sonstiges') echo 'selected'; ?> >Sonstiges</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="period" id="exampleEmail11" class="form-control date_range" required disabled>
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="exampleEmail11" class=""><?php echo trans('forms.for'); ?> <font style="color:red;">*</font></label>
                                                        <select name="for" class="form-control" required disabled>
                                                            <option value="Full Day" <?php if($sick_leave->forr=='Full Day') echo 'selected'; ?> >Full Day</option>
                                                            <option value="Half Day (Morning)" <?php if($sick_leave->forr=='Half Day (Morning)') echo 'selected'; ?> >Half Day (Morning)</option>
                                                            <option value="Half Day (Afternoon)" <?php if($sick_leave->forr=='Half Day (Afternoon)') echo 'selected'; ?> >Half Day (Afternoon)</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-12" id="voucher">
                                                    <input type="hidden" name="documents" id="files" value="<?php echo $sick_leave->documents; ?>">
...
<script>
    ...
    $('.date_range').daterangepicker({
        startDate: '<?php echo date_format(new DateTime($sick_leave->beginning),'d-m-Y'); ?>',
        endDate: '<?php echo date_format(new DateTime($sick_leave->end),'d-m-Y'); ?>',
        locale: {
            format: 'DD-MM-YYYY'
        }
    });
