                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.new_referral_source'); ?></h5>
                                        <form class="" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <thead>
                                                    <tr>
                                                        <th><?php echo trans('dashboard.referral_source'); ?></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <!--<a href="<?php echo url('admin/edit-referral-source/'.$source->id); ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                        ...
                                                        <button class="border-0 btn-transition btn btn-outline-danger" onclick="return confirm('Do you really want to delete this referral source?');">
