    ...
    .pi-image-box{
        ...
        cursor: pointer;
                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.add_new_user'); ?></h5>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="username" id="exampleEmail11" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="examplePassword11" class=""><?php echo trans('forms.password'); ?> <font style="color:red;">*</font></label>
                                                        <input name="pass" id="examplePassword11" type="password"class="form-control" required></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="email" id="examplePassword11" type="email"class="form-control" required></div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <option value="3"><?php echo trans('forms.manager'); ?></option>
                                                        <option value="2"><?php echo trans('forms.admin'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="jay-signature-pad--body" style="width:100%;">
                <center><canvas id="jay-signature-pad" style="max-width:100%;" width="300" height="150"></canvas></center>
            </div>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo trans('dashboard.username'); ?></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <p><?php echo $user->email; ?></p></td>
                                                        <td><?php 
                                                                if($user->type=='2') echo trans('forms.admin');
                                                                else if($user->type=='3') echo trans('forms.manager');
                                                            ?></td>
                                                        <td><?php echo $user->username; ?></td>
                                                        <td>
                                                            <?php if($user->last_login!='0000-00-00 00:00:00') { ?>
                                                            <?php echo date_format(new DateTime($user->last_login),'d-m-Y'); ?>
                                                            <p><?php echo date_format(new DateTime($user->last_login),'H:i'); ?></p>
                                                            <?php } else echo 'NA'; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo date_format(new DateTime($user->created_on),'d-m-Y'); ?>
                                                            <p><?php echo date_format(new DateTime($user->created_on),'H:i'); ?></p>
                                                        </td>
                                                        <td>
                                                        <a href="<?php echo url('admin/edit-user/'.$user->id); ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                        ...
                                                        <button class="border-0 btn-transition btn btn-outline-danger" onclick="return confirm('Do you really want to delete this user?');">
