...
<li class='nav-item'>
<a aria-controls='attendance-report<?php echo $course['course']->id; ?>' aria-selected='false' class="nav-link" data-toggle='tab' href='#attendance-report<?php echo $course['course']->id; ?>' id='attendance-report-tab-<?php echo $course['course']->id; ?>' role='tab'>Attendance Report</a>
</li>
</ul>
                                    ...
                                    <div class='tab-content'>
                                        <div aria-labelledby='attendance-tab-<?php echo $course['course']->id; ?>' class="tab-pane fade show active" id='attendance<?php echo $course['course']->id; ?>' role='tabpanel'>
                                            <div class="form-row d-none">
                                                ...
                                                <form action="" method="get">
                                                    <input type="hidden" name="c" value="<?php echo $course['course']->id; ?>">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="examplePassword11" class="">Date Range</label>
                                                        <input name="d" type="text" class="form-control date_range" id="attendance_date">
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="examplePassword11" class="">Student</label>
                                                        <select class="form-control" name="s">
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $student['student']->id; ?>" <?php if(isset($_GET['c']) AND $course['course']->id==$_GET['c'] AND $_GET['s']==$student['student']->id) echo 'selected'; ?> ><?php echo $student['student']->name; ?></option>
                                                            <?php } } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                    <label for="examplePassword11" class="" style=""></label>
                                            ...
                                            <table style="width: 100%;" class="table table-hover table-striped table-bordered dynamic-table">
                                                                ...
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo $attendance['attendance']->date; ?></td>
                                                                    <td><?php echo $attendance['module']->title.' / '.$attendance['appointment']->title; ?></td>
                                                                    <td><?php echo $attendance['student']->name; ?>
                                                                        <p style="color:#777;"><?php echo $attendance['student']->email; ?></p>
                                                                    </td>
                                                                    <td><?php 
                                                                            if($attendance['attendance']->status==0) echo 'Absent<br>';
                                                                            else if($attendance['attendance']->status==1) echo 'Present<br>';
                                                                            else if($attendance['attendance']->status==2) echo 'Late <p style="color:#777;">('.$attendance['attendance']->late.' mins)</p>';
                                                                            
                                                                            if($attendance['sick_leave']!='NA')
                                                                            {
                                                                                if(!empty($attendance['sick_leave']->documents))
                                                                                {
                                                                                    $documents=explode(',', $attendance['sick_leave']->documents);
                                                                                    echo '<b>Sick leave:</b>';
                                                                                    foreach($documents as $doc)
                                                                                    {
                                                                                        echo "<br><a href='".url('company_files/documents/'.$doc)."' target='_blank'>".$doc."</a><br>";
                                                                                    }
                                                                                }
                                                                            }
                                                                        ?></td>
                                                                    <td><?php echo $attendance['attendance']->notes; ?></td>
                                                                    
                                                                    <td><?php if( !empty($attendance['attendance']->pdf_url)) {?><a target="_blank" href="<?php echo url('company_files/tagesdoku/'. $attendance['attendance']->pdf_url); ?>">Tagesdoku PDF</a><?php }?></td>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-12">
                                                    <h5>Appointments Notes:</h5>
                                                    <div id="notes-box2">
                                                        <?php 
                                                            if(!empty($course['attendance_notes'])) {
                                                                foreach($course['attendance_notes'] as $note) {
                                                            ?>
                                        ...
                                        <div aria-labelledby='appointments-tab-<?php echo $course['course']->id; ?>' class="tab-pane fade" id='appointments<?php echo $course['course']->id; ?>' role='tabpanel'>
                                                                ...
                                                                <tr id="app-<?php echo $appointment['appointment']->id; ?>">
                                                                    ...
                                                                    <td style="max-width:140px;"><?php echo $appointment['coach']; ?></td>
                                                                    <!--<td><button class="btn btn-success" onclick="open_register('<?php //echo $course['course']->id; ?>' ,'<?php //echo date_format(new DateTime($appointment['appointment']->date),'d-m-Y'); ?>')">Attendance</button></td>-->
                                                                </tr>
                                                                <?php } } ?>
                                                                </tbody>
                                                                <tfoot>
                                        ...
                                        <div aria-labelledby='attendance-report-tab-<?php echo $course['course']->id; ?>' class="tab-pane fade" id='attendance-report<?php echo $course['course']->id; ?>' role='tabpanel'>
                                                                ...
                                                                <tbody>
                                                                <?php 
                                                                    if(!empty($course['attendance_report'])) {
                                                                        foreach($course['attendance_report'] as $attendance_report) {
                                                                ?>
                                                                <tr id="app-<?php echo $attendance_report['student']->id; ?>">
                                                                    <td><?php echo $attendance_report['student']->name; ?></td>
                                                                    <td><?php echo $attendance_report['percentage']; ?></td>
                                                                    <td><?php echo $attendance_report['percentage']; ?></td>
                                                                    <!--<td><button class="btn btn-success" onclick="open_register('<?php //echo $course['course']->id; ?>' ,'<?php //echo date_format(new DateTime($appointment['appointment']->date),'d-m-Y'); ?>')">Attendance</button></td>-->
                                                                </tr>
                                                                <?php } } ?>
...
<script>
    function open_register(course_id, date)
    {
    ...
    $('.date_range').daterangepicker({
        startDate: <?php if(isset($_GET['d'])) { echo "'".explode(' - ', $_GET['d'])[0]."'"; } else { ?>new Date()<?php } ?>,
        endDate: <?php if(isset($_GET['d'])) { echo "'".explode(' - ', $_GET['d'])[1]."'"; } else { ?>new Date()<?php } ?>,
        locale: {
            format: 'DD-MM-YYYY'
        }
    });
    ...
    function change_date(course_id)
    {
        ...
        $.ajax({
                url: "<?php echo url('admin/attendance-register-date') ?>",
                type: "POST",
                data:  formData,
                beforeSend: function(){ //alert('sending');
                },
        ...
        $.ajax({
                url: "<?php echo url('admin/attendance-fetch-notes-date') ?>",
                type: "POST",
                data:  formData,
                beforeSend: function(){ //alert('sending');
                },
