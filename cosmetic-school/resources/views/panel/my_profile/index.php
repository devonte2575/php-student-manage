                  ...
                  <label><?php echo trans('forms.update_profile_image'); ?></label>
                      <input type="file" class="form-control file" name="image" style="display:none;" accept="image/*">
                              ...
                              <img src="" id="current_img" style="max-width:300px; display:block;">
                                                ...
                                                <div class="col-md-6 <?php if($user->type!='1') echo 'd-none'; ?>" >
                                                    <div class="position-relative form-group">
                                                        <label for="exampleEmail11" class=""><?php echo trans('forms.email'); ?> <font style="color:red;">*</font></label>
                                                        <input name="email" id="exampleEmail11" type="email" class="form-control" required value="<?php echo $user->email; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <h5 class="card-title"><?php echo trans('dashboard.manage_availability'); ?>:</h5>
                ...
                <div class="signature-pad--actions txt-center">
                    <div>
                        <button type="button" class="button clear" data-action="clear"><?php echo trans('forms.clear'); ?></button>
                                                            ...
                                                            <button class="mt-2 btn btn-primary" id="mysignature" style="margin-left:600px;"><?php echo trans('forms.update'); ?></button>                                                
        </div>                                           <p class="alert alert-success" id="signaturesuccess" style="display:none;">Your signature has been updated successfully.</p>
                                                    </div>
...
<script>
    ...
    window.success=0;
     ...
     $("#mysignature").click(function(e){
        ...
        $.ajax({
                url: "<?php echo url('/admin/add-signature') ?>",
                type: "POST",
                data:  formData,
