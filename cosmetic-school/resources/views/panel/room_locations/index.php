                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.add_new_location'); ?></h5>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date_format(new DateTime($location->added_on),'m-d-Y'); ?>
                                                            <p><?php echo date_format(new DateTime($location->added_on),'H:i'); ?></p>
                                                        </td>
                                                        <td>
                                                        <a href="<?php echo url('admin/edit-room-location/'.$location->id); ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                        ...
                                                        <form action="" method="post" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="delete" value="<?php echo $location->id; ?>">
                                                        <button class="border-0 btn-transition btn btn-outline-danger" onclick="return confirm('Do you really want to delete this room location?');">
