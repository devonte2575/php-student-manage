                            ...
                            <ul>
                                ...
                                ?>
                                        <li>
                                            ...
                                            <label> <input type="checkbox" class="p-<?php echo $p['product']->id; ?> m-<?php echo $m['module']->id; ?>" name="items<?php echo $m['module']->id; ?>[]" value="<?php echo $item['item']->id; ?>" id="mi-<?php echo $mi_id; ?>" data-id="cmi2-<?php echo $mi_id; ?>" onclick="item_selected('<?php echo $p_id; ?>'); item_selected2('<?php echo $p_id; ?>', '<?php echo $m_id; ?>')" onchange="select_product('<?php echo $p_id; ?>');" mdid="<?php echo $m['module']->id; ?>">

                                                <?php echo $item['item']->title; ?>
                                            </label>

                                            <?php echo ' ( ' . trans('forms.lessons') . ': <input type="number" name="lessons' . $item['item']->id . '" value="' . $item['item']->lessons . '" style="max-width:60px; padding-top:0px; padding-bottom:0px;" min="0" max="' . $item['item']->lessons . '" required> ' . trans('forms.price_lesson') . ': € <input readonly ="number" name="prices' . $item['item']->id . '" value="' . $item['item']->price_lessons . '" style="max-width:60px; padding-top:0px; padding-bottom:0px;" required min="0" step="any"> )'; ?>
