                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.edit_room_location'); ?></h5>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="name" id="exampleEmail11" type="text" class="form-control" required value="<?php echo $location->name; ?>">
                                                    </div>
                                                </div>
                                            </div>
