                        ...
                        <div class="app-inner-layout__wrapper">
                            ...
                            <div class="app-inner-layout__content pt-0">
                                <div class="tab-content">
                                    ...
                                    <div class="card-body"><h5 class="card-title"><?php echo trans('forms.add_new_funding_source'); ?></h5>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="address" id="exampleEmail11" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo trans('dashboard.address'); ?></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $source->address; ?></td>
                                                        <td><?php echo date_format(new DateTime($source->added_on),'m-d-Y'); ?>
                                                            <p><?php echo date_format(new DateTime($source->added_on),'H:i'); ?></p>
                                                        </td>
                                                        <td>
                                                        <a href="<?php echo url('admin/edit-funding-source/'.$source->id); ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                        <i class="fa fa-edit"></i>
                                                        </button></a>
                                                            
                                                        <form action="" method="post" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="delete" value="<?php echo $source->id; ?>">
                                                        <button class="border-0 btn-transition btn btn-outline-danger" onclick="return confirm('Do you really want to delete this funding source?');">
