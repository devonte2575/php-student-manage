                ...
                <div class="signature-pad--actions txt-center">
                    <div>
                        <button type="button" class="button clear" data-action="clear">Clear</button>
                                                ...
                                                <button class="btn btn-success mt-3" style="width:100%;" id="submit_btn">Submit Document</button>
                                                </form>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function(){
        ...
        PDFObject.embed("<?php echo url('contracts/'.$contract->contract) ?>", "#pdfRenderer", options);
    });
</script>
...
<script>
    ...
    $("#signature-form").submit(function(e){
        ...
        $.ajax({
                url: "<?php echo url('admin/save-signature') ?>",
                type: "POST",
                data:  formData,
