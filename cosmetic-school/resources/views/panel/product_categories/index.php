                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date_format(new DateTime($category->added_on),'m-d-Y'); ?>
                                                            <p><?php echo date_format(new DateTime($category->added_on),'H:i'); ?></p>
                                                        </td>
                                                        <td>
                                                        <a href="<?php echo url('admin/edit-product-category/'.$category->id); ?>"><button class="border-0 btn-transition btn btn-outline-success">
