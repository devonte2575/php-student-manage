                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                ...
                                                <div class="btn-actions-pane-right actions-icon-btn">
                                                    <a href="<?php echo url('admin/export-subscribers'); ?>" target="_blank"><button type="button" class="btn-shadow btn btn-wide btn-success">
                                                    <i class="fa fa-file-csv"></i> Export All
                                                    </button></a>
                                                    
                                                    <form action="<?php echo url('admin/export-subscribers'); ?>" method="get" target="_blank" style="display:inline;">
                                                        <input type="hidden" name="users" value="" id="subscribers">
                                                    <button type="submit" class="btn-shadow btn btn-wide btn-success" id="export_btn" disabled>
                                                    <i class="fa fa-file-csv"></i> Export Selected
                                                    </button>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo trans('forms.name'); ?></th>
                                                        <th><?php echo trans('forms.type'); ?></th>
                                                        <th><?php echo trans('header.regular_courses'); ?></th>
                                                        <th><?php echo trans('header.coaching_courses'); ?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php 
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="contact" value="<?php echo $user['contact']->id; ?>" onchange="subscribers(this, this.value)"></td>
                                                        <td><?php echo $user['contact']->email; ?></td>
                                                        <td><?php echo $user['contact']->name; ?></td>
                                                        <td><?php echo $user['type']; ?></td>
                                                        <td><?php echo $user['regular']; ?></td>
                                                        <td><?php echo $user['coaching']; ?></td>
                                                    </tr>
                                                    <?php } } ?>
                                                    </tbody>
                                                    <tfoot>
...
<script>
    function subscribers(th, id){
        var old_ids=$("#subscribers").val();
        if(old_ids!='')
        ...
        $("#subscribers").val(new_ids);
        
        if(new_ids!='') $("#export_btn").attr('disabled', false);
        else $("#export_btn").attr('disabled', true);
    }
