                                                ...
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="title" class="form-control" required>
                                                            ...
                                                            <option value="Todesfall in der Familie">Todesfall in der Familie</option>
                                                            <option value="Amtstermin">Amtstermin</option>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo date_format(new DateTime($leave['leave']->beginning),'d-m-Y').' - '.date_format(new DateTime($leave['leave']->end),'d-m-Y'); ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo url('edit-sick-leave/'.$leave['leave']->id); ?>"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
                                                            
                                                            <form action="" method="post" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="delete" value="<?php echo $leave['leave']->id; ?>">
                                                        <button class="border-0 btn-transition btn btn-outline-danger" onclick="return confirm('Do you really want to remove this sick leave?');">
