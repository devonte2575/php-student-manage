...
<body style="margin:0px;">
    ...
    <div style="position:absolute; left:0pt; width:350px; padding-top:100px; height:100vh; padding-left:55px;">
    ...
    <div style="margin-left:350px; padding-top:100px; width:350px; padding-left:55px;">
    ...
    <div style="padding-left:55px; padding-top:20px; margin-right:55px;">
        <b><?php if(isset($personal_details->title)) echo 'Bewerbung als '.$personal_details->title; ?></b>
