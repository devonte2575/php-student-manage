                                            ...
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="card-hover-shadow-2x mb-3 card">
                                                    <div class="d-block card-header mt-3 pb-0">
                                                        ...
                                                        <button class="btn btn-primary float-right" data-toggle="modal" data-target="#add-task" onclick="$('#task_id').val('0'); $('#task_title').val(''); $('#task_description').val(''); $('#task_assign_to').val('0'); $('#modal-title-task').text('<?php echo trans('dashboard.add_todo'); ?>'); $('#reminder').prop('checked', false); $('#reminder_field').attr('readonly', true); $('#file_name').hide(); $('#task_priority').val('')"><?php echo trans('dashboard.add_todo'); ?></button>
                                                    </div>
                                                                        ...
                                                                        <div class="widget-content p-0">
                                                                            ...
                                                                            echo '<i class="fa fa-hourglass-'.$s.'"></i> <font style="text-decoration:underline;">'.$due_date.'</font> &nbsp;'; ?>
                                                                                ...
                                                                                <div class="widget-content-right">
                                                                                    <button class="border-0 btn-transition btn btn-outline-success" onclick="edit_task('<?php echo $todo['todo']->id; ?>', '<?php echo $todo['todo']->title; ?>', '<?php echo $todo['todo']->priority; ?>', '<?php echo $todo['todo']->description; ?>', '<?php echo date_format(new DateTime($todo['todo']->due_date),'d-m-Y'); ?>', '<?php echo $todo['todo']->assign_to; ?>', '<?php echo $todo['todo']->reminder; ?>', '<?php echo date_format(new DateTime($todo['todo']->reminder_date),'d-m-Y h:i A'); ?>')" data-toggle="modal" data-target="#add-task">
                                                                    ...
                                                                    <li class="list-group-item" id="task-<?php echo $todo['todo']->id; ?>">
                                                                        ...
                                                                        <div class="widget-content p-0">
                                                                            ...
                                                                            echo '<i class="fa fa-hourglass-'.$s.'"></i> <font style="text-decoration:underline;">'.$due_date.'</font> &nbsp;'; ?>
                                                                                ...
                                                                                <div class="widget-content-right">
                                                                                    <button class="border-0 btn-transition btn btn-outline-success" onclick="edit_task('<?php echo $todo['todo']->id; ?>', '<?php echo addslashes($todo['todo']->title); ?>', '<?php echo $todo['todo']->priority; ?>', '<?php echo addslashes($todo['todo']->description); ?>', '<?php echo date_format(new DateTime($todo['todo']->due_date),'d-m-Y'); ?>', '<?php echo $todo['todo']->assign_to; ?>', '<?php echo $todo['todo']->reminder; ?>', '<?php echo date_format(new DateTime($todo['todo']->reminder_date),'d-m-Y h:i A'); ?>')" data-toggle="modal" data-target="#add-task">
                                                                                        <i class="fa fa-edit"></i>
                                                                                    </button>
                                                                                    <button class="border-0 btn-transition btn btn-outline-danger" onclick="delete_todo('<?php echo $todo['todo']->id; ?>')">
                                                                                        <i class="fa fa-trash-alt"></i>
